...
namespace GuardAgainstLib.Test
{
    public class Test_ArgumentBeingLessThanMinimum
    {
        ...
        public void WhenArgumentIsLessThanMinimum_ShouldThrowArgumentOutOfRangeException<T>(T value, T minimumValue, string argumentName, string errorMessage) where T : IComparable<T>
        {
        ...
        public void WhenArgumentIsGreaterThanOrEqualToMinimum_ShouldThrowNotException<T>(T value, T minimumValue, string argumentName, string errorMessage) where T : IComparable<T>
        {
            Should.NotThrow(() =>
            {
                GuardAgainst.ArgumentBeingLessThanMinimum(value, minimumValue, argumentName, errorMessage);
        ...
        public void WhenMinimumValueIsNull_ShouldThrowArgumentNullException<T>(T value, T minimumValue, string argumentName, string errorMessage) where T : IComparable<T>
        {
        ...
        public void WhenArgumentIsNull_ShouldNotThrowException(string value, string minimumValue, string argumentName, string errorMessage)
        {
            Should.NotThrow(() =>
            {
                GuardAgainst.ArgumentBeingLessThanMinimum(value, minimumValue, argumentName, errorMessage);
        ...
        public static IEnumerable<object[]> DataWhereArgumentIsNull =>
            new List<string[]>
            {
                new string[] { default(string), "a", "myArg", "Err msg!" },
                new string[] { default(string), "a", "myArg", default(string) },
                new string[] { default(string), "a", default(string), "Err msg!" },
                new string[] { default(string), "a", default(string), default(string) },
            };
    }
}
